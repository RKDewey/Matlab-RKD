...
% the one with the lowest mean fit error.  Version 2.4: May, 2012, 
% Exponential broadening uses normal rather than circular convolution. 
%
% PEAKFIT(signal);       
...
%
% T. C. O'Haver (toh@umd.edu). Version 2.4 
%  
% Example 1: 
...
switch AUTOZERO,
    case 0
    title('Peakfit 2.4. Autozero OFF.')
    case 1
    title('Peakfit 2.4. Linear autozero.')
    case 2
    title('Peakfit 2.4. Quadratic autozero.')
end
